<?php
// source: C:\Users\jsivc\OneDrive\Dokumenty\GitHub\nette-project\nette/config/common.neon
// source: C:\Users\jsivc\OneDrive\Dokumenty\GitHub\nette-project\nette/config/services.neon
// source: array
...
class Container_0108e51276 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'Nette\Application\UI\Presenter' => [
			2 => ['01', 'application.1', 'application.2', 'application.4', 'application.5'],
		],
		'Nette\Application\UI\Control' => [2 => ['01', 'application.1', 'application.2', 'application.4', 'application.5']],
		...
		'App\UI\Sign\SignPresenter' => [2 => ['01']],
		...
		'App\UI\Test\TestPresenter' => [2 => ['application.5']],
	...
	public function createService01(): App\UI\Sign\SignPresenter
	{
	...
	{
		$service = new App\UI\Edit\EditPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__5(): App\UI\Test\TestPresenter
	{
		$service = new App\UI\Test\TestPresenter;
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\Users\jsivc\OneDrive\Dokumenty\GitHub\nette-project\nette/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('C:\Users\jsivc\OneDrive\Dokumenty\GitHub\nette-project\nette/temp/cache');
	}


	public function createServiceContainer(): Container_0108e51276
	{
		return $this;
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=127.0.0.1;dbname=nette',
			/*sensitive{*/'root'/*}*/,
			/*sensitive{*/'admin'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_0108e51276 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\Users\jsivc\OneDrive\Dokumenty\GitHub\nette-project\nette/temp/cache/latte');
	...
	{
		return $this->getService('02')->createRouter();
	}
